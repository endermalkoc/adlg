...
func DefaultCentralConfigPath() string {
	...
	return filepath.Join(home, ".config", "asdf", CentralConfigFileName)
}
...
func ApplyCentralDefaults(project *Config, central *Config) {
	...
	// ASDF_DOLT_SERVER_TLS=0 env var.
